...
function DoctorAppointments() {
    ...
    },
    {
      ...
      render: (text, record) => (
        <td className="px-6 py-4 whitespace-nowrap text-right">
          <button
            className="px-4 py-2 text-sm font-medium text-white bg-[#00BDA9] rounded-md hover:bg-[#00BDA9] focus:ring-4 focus:outline-none focus:ring-blue-300"
  ...
  return (
    <Layout>
      <h1 className="text-2xl font-bold  mt-[12px] mb-[12px] ml-[12px] text-[#00BDA9]">Appointments</h1>
